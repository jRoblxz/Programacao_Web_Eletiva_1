...
<main class="container_1">
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $soma = $valor1 + $valor2;
        if ($valor1 == $valor2) {
          echo "<div class='result_div'><p class='resultado'>Os números são iguais.</p></div>";
        } else {
            if ($valor1 < $valor2) {
                $menor = $valor1;
                $maior = $valor2;
              ...
              echo "<div class='result_div'><p class='resultado'>Valores em ordem crescente:$menor,$maior.</p></div>";
          }    
    }
