...
<main class="container_1">
    ...
    <form method="post">
        <div class="row inline-row mb-3">
            <div class="col-md-12">
                <label for="valor1" class="form-label">Insira um número:</label>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        $valor = $_POST['valor1'];
        echo "<div class='result_div'><span class='resultado'>A raiz quadrada de $valor é </span>&nbsp;<span class='resultado'>" . calcularRaizQuadrada($valor) . "</span></div>";
    }
    include 'rodape.php';
    ?>