...
<main class="container_1">
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        echo "<div class='result_div'>
                <div class='resultado'>Maiúsculo: <span class='resultado'>" . $resultados['maiusculo'] . "</span></div>
            </div>";
        echo "<div class='result_div'>
                <div class='resultado'>Minúsculo: <span class='resultado'>" . $resultados['minusculo'] . "</span></div>
            </div>";
    }
