        ...
        <form method="post">
            ...
            <div class="d-flex justify-content-between mt-3">
                ...
                <div class="d-flex gap-2">
                    <button class="btn btn-primary" type="button" onclick="window.location.href='exercicio5.php'">Voltar</button>
                    <button class="btn btn-primary" type="button" onclick="window.location.href='exercicio7.php'">Próximo</button>
                </div>
            </div>
        </form>
        <?php
